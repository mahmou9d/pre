...
function CartPage() {
  const { data: itemsData = [], isLoading } = useGetCartItems();
      ...
      <div className="bg-[#FAFAF7] min-h-screen mt-20">
        <div className="max-w-[1440px] mx-auto px-4 lg:px-8 py-10 lg:py-14">
          <div className="flex flex-wrap items-center justify-between gap-4 mb-6">
            <span className="inline-block bg-[#0A0A0A] text-[#D4FF3D] text-[11px] font-black uppercase tracking-wider px-3 py-1.5 -rotate-1">
              {itemCount} items
            </span>
            <button
              type="button"
              onClick={() => clearCart()}
              className="text-[11px] font-black uppercase text-[#FF4D00] hover:underline"
            >
              Clear Bag
            </button>
          </div>
          ...
          <div className="grid lg:grid-cols-[1fr_380px] gap-10 lg:gap-12 items-start">
                    ...
                    >
                      ...
                      <div className="hidden md:flex items-center gap-4 justify-end">
                        ...
                        <button
                          ...
                          aria-label={`Remove ${item.variant?.product_name || item.name}`}
                        >
            ...
            <div className="lg:sticky lg:top-34">
              <div className="bg-[#0A0A0A] text-[#FAFAF7] p-6 lg:p-7">
                ...
                <Link href="/checkout">
                  <span className="mt-6 w-full flex items-center justify-center gap-2 bg-[#D4FF3D] text-[#0A0A0A] py-4 text-[13px] font-black uppercase tracking-wide hover:bg-[#FAFAF7] active:translate-x-[2px] active:translate-y-[2px] transition-all cursor-pointer">
                    Checkout
                    <ArrowRight size={15} strokeWidth={3} />
                  </span>
                </Link>
